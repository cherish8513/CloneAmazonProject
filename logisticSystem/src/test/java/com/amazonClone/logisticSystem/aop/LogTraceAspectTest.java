package com.amazonClone.logisticSystem.aop;

import com.amazonClone.logisticSystem.aop.aspect.LogTraceAspect;
...
public class LogTraceAspectTest {
    ...
    public void isAvailablePointcut() throws Exception{
        pointcut.setExpression("execution(* com.amazonClone.logisticSystem..*(..)) && execution(* *..*Service*.*(..))");
    ...
    public void isAvailablePointcutRepository() throws Exception{
        pointcut.setExpression("execution(* com.amazonClone.logisticSystem..*(..)) && execution(* *..*Repository*.*(..))");
