...
public class QDelivery extends EntityPathBase<Delivery> {
    ...
    private static final long serialVersionUID = 1137820869L;
    ...
    public final SimplePath<com.logistic.domain.util.Address> address = createSimple("address", com.logistic.domain.util.Address.class);
    ...
    public final com.logistic.domain.order.QOrder order;
    ...
    public QDelivery(Class<? extends Delivery> type, PathMetadata metadata, PathInits inits) {
        ...
        this.order = inits.isInitialized("order") ? new com.logistic.domain.order.QOrder(forProperty("order"), inits.get("order")) : null;
    }
